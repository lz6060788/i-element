...
/** 构建选项的默认值 */
export declare function defaultOptions(): Required<GenerateConfigOptions>;
/** 解析构建选项 */
export declare function getOptions(options?: GenerateConfigOptions): Required<GenerateConfigOptions>;
