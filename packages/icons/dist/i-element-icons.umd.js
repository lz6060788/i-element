(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("node:path"), require("node:fs/promises"), require("@iconify/tools"), require("@iconify/utils")) : typeof define === "function" && define.amd ? define(["exports", "node:path", "node:fs/promises", "@iconify/tools", "@iconify/utils"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.iElementIcons = {}, global.node_path, global.promises, global.tools, global.utils));
