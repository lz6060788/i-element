(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("unocss")) : typeof define === "function" && define.amd ? define(["exports", "unocss"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.preset = {}, global.unocss));
})(this, function(exports2, unocss) {
  "use strict";
  const themeColors = {
  ...
  const themeConfig = {
    preflights: [
      {
        // 在生成的 css 样式文件中填入所有主题变量的定义,注入节点
  ...
  function iElementPreset(options = {}) {
    const {
    ...
    const mergedConfig = unocss.mergeConfigs(configs);
    return {
      name: "i-element-preset",
      ...mergedConfig
    };
  }
  exports2.iElementPreset = iElementPreset;
